...
BEGIN_MESSAGE_MAP(CdominoApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CdominoApp::OnAppAbout)
...
CdominoApp::CdominoApp()
{
	...
	SetAppID(_T("domino.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CdominoApp

CdominoApp theApp;


// инициализация CdominoApp
